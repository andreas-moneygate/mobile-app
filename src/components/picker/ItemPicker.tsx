...
import { ItemSectionsList } from 'components/list/ItemSectionsList'
...
export const ItemPicker = memo((props: ItemPickerProps) => {
  ...
  const snapPoints = useMemo(() => ['1%', Math.min(100 + data.length * 60, 700)], [data.length])
  ...
  return (
    <Column>
      ...
      <CustomBottomModalSheet snapPoints={snapPoints} innerRef={bottomSheetModalRef}>
        <ItemSectionsList data={data} value={value} onSelect={handleSelect} />
